...
";
    ...
    {
        return array (  105 => 19,  91 => 18,  77 => 16,  65 => 14,  62 => 13,  45 => 12,  38 => 7,  35 => 6,  29 => 4,  11 => 2,);
    }
    ...
    <div class=\"col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4\">
        <div class=\"panel panel-default\">
            ...
            {% for cancha in canchas %}
                {% if cancha.disponibilidad == 'No disponible' %}
                    <a class=\"fila {{cycle([\"par\",\"impar\"], loop.index)}}\"> {{ cancha.id }} - {{ cancha.tipo }} - {{ cancha.disponibilidad}} </a>
                {% else %}
