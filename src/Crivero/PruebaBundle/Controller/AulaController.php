...
class AulaController extends Controller {
    ...
    public function disponibilidadAulaAction($id, Request $request) {
        ...
        return $this->render('CriveroPruebaBundle:Aulas:disponibilidadAula.html.twig', array("horarios" => $pagination,
