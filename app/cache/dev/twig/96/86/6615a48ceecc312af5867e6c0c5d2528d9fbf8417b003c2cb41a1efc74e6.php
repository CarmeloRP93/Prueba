...
/* moduloclientesclienteBundle:Default:nuevoJugadorCliente.html.twig */
class __TwigTemplate_96866615a48ceecc312af5867e6c0c5d2528d9fbf8417b003c2cb41a1efc74e6 extends Twig_Template
{
    ...
    public function block_contenido($context, array $blocks = array())
    {
        ...
        <div class=\"form-group\">
            ";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "primerApellido", array()), 'label');
        echo "
            ";
        // line 23
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "primerApellido", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
            <span class=\"text-danger\">";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "primerApellido", array()), 'errors');
        echo "</span>
        </div>
        ...
        echo "
            ";
        // line 29
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "segundoApellido", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
            <span class=\"text-danger\">";
        // line 30
...
";
    ...
    {
        return "moduloclientesclienteBundle:Default:nuevoJugadorCliente.html.twig";
    }
    ...
    {
        return array (  147 => 48,  142 => 46,  135 => 42,  131 => 41,  127 => 40,  120 => 36,  116 => 35,  112 => 34,  105 => 30,  101 => 29,  97 => 28,  90 => 24,  86 => 23,  82 => 22,  75 => 18,  71 => 17,  67 => 16,  60 => 12,  56 => 11,  50 => 8,  46 => 6,  43 => 5,  37 => 3,  11 => 1,);
    }
}
