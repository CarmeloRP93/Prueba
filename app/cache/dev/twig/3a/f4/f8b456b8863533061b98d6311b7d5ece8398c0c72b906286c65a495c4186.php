...
class __TwigTemplate_3af4f8b456b8863533061b98d6311b7d5ece8398c0c72b906286c65a495c4186 extends Twig_Template
{
    ...
    public function block_contenido($context, array $blocks = array())
    {
        ...
        <h1 class=\"t1\">Listado de sesiones de dedicadas</h1>
        ";
        // line 8
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sesion"]) {
            ...
            if (($this->getAttribute($context["sesion"], "cliente", array()) != "normal")) {
                // line 10
                echo "                <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("modulomonitores_monitores_miSesionDedicada", array("id" => $this->getAttribute($context["sesion"], "id", array()))), "html", null, true);
                echo "\" class=\"fila ";
        ...
        echo "\" class=\"btn btn-success col-sm-1\" style=\"height: 30px; width: 200px;\">Nueva sesion dedicada<span class=\"glyphicon glyphicon-plus\"></span></a>
        </div>
    </div>
";
    }
